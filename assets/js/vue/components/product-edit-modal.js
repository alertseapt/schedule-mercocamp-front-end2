...
const ProductEditModal = {
    ...
    computed: {
        hasChanges() {
            return this.editableProduct.client_description !== this.originalDescription;
        },
        
        canSave() {
            return this.hasChanges && this.editableProduct.client_description && this.editableProduct.client_description.trim() !== '';
        }
    },
    ...
    methods: {
        ...
        async loadProductHistory() {
            ...
            try {
                ...
                const response = await apiClient.request(`/products/${identifier}/history`, {
                    method: 'GET'
                });
        ...
        async saveDescription() {
            ...
            try {
                ...
                const response = await apiClient.request('/products/update-description', {
                    method: 'PUT',
                    data: {
                ...
                // Emitir evento para atualizar produto pai
                ...
                this.showError(error.response?.data?.message || 'Erro ao salvar descrição do produto');
            } finally {
                this.loading = false;
            }
        },
                    ...
                    <div class="product-info">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <span>{{ editableProduct.quantity }} {{ editableProduct.unit }}</span>
                            </div>
                            <div class="info-item">
                    ...
                    <div class="editable-fields">
                        ...
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                :class="{ 'is-invalid': !editableProduct.client_description && hasChanges }">
                            </textarea>
                            <div v-if="!editableProduct.client_description && hasChanges" class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Fator usado para converter a quantidade do fornecedor para a quantidade do cliente
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="history-section">
                        <div class="history-header">
                            ...
                            <button 
                                ...
                                @click="toggleHistory">
                                <i :class="showHistory ? 'fas fa-chevron-up' : 'fas fa-chevron-down'"></i>
