    ...
    hasPermission(permission) {
        ...
        try {
            ...
            const permissions = {
                ...
                1: ['view_schedules', 'create_schedule'],
                
                // Nível 2 - Administrador (acesso administrativo)
                2: ['view_schedules', 'create_schedule', 'edit_schedule', 'delete_schedule', 'manage_users'],
                
                // Nível 3 - Gerente (acesso gerencial)
                3: ['view_schedules', 'create_schedule', 'edit_schedule', 'manage_products', 'view_reports']
            };
